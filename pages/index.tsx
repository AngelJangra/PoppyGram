...
function Accounts(p:{accounts:Account[];q:string;setQ:(s:string)=>void;action:(p:string,b?:any)=>void;onOpen:(p:string)=>void}){
  ...
  <div className="table"><div className="thead"><span>Account</span><span>Status</span><span>Interval</span><span>Next ping</span><span>Actions</span></div>
